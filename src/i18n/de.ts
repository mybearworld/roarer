export const de = {
  ...
  developmentStatus: {
    start:
      "Wichtig: Roarer ist in einer sehr frühen Entwicklungsphase. Bitte melde Fehler oder schlage Features auf ",
  ...
  splashBridgePost:
    "Dieser Post wurde mit Splash erstellt. Diese gehen nicht durch Meowers oder Splashs Kontosystem, jeder kann unter jedem Namen eine Nachricht schreiben.",
