export const es = {
    ...
    chatRemove: "Remover",
    profileInformationFail: "No se ha podido obtener información del perfil: {status}",
    ...
    disconnected: "Has sido desconectado. Al hacer clic en Aceptar se recargará la página.",
    myAccount: "Mi cuenta",
