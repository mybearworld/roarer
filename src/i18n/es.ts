...
export const es = {
  ...
  permBlockIPs: "Puede bloquear ciertas direcciones IP para usar Meower",
  ...
  settingAnyImageHostWarn: "ADVERTENCIA: Esto permitirá que cualquier sitio web se utilice como host de imágenes, y se realizará automáticamente una solicitud a él. Esto podría hacer que tu dirección IP se muestre al sitio web. Úsalo de forma responsable.",
  settingFilterSwears: 'Filtrar palabras malsonantes de los mensajes y reemplazarlas por "****".',
  settingEnterSends: "Enviar mensaje al presionar Enter. Aún puedes crear nuevas líneas presionando Shift+Enter.",
  postFail: "Error al enviar el mensaje: {status}",
  deletePostFail: "Error al eliminar el mensaje: {status}",
  notoColorEmoji: "Los emojis utilizan la fuente Noto Color Emoji, con licencia de la Licencia de fuente abierta.",
